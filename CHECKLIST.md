...
- [x] **ODinW SIZE GRADIENT — THE DEFINING RESULT**: W4 recall loss small −53% / medium −26% / large −0%; quantization destroys fine spatial precision on a monotonic size gradient, invisible to large-object benchmarks (explains the RefCOCO "proportional" reading); GCQ recovers 55–58% of small/medium loss — **ALL EXPERIMENTS COMPLETE**
